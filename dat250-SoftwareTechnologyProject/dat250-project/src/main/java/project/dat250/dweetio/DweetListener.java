package project.dat250.dweetio;
...
public interface DweetListener 
{
    ...
    /**
     * Stop listening to a thing. Should affect the return of {@link #isStillListeningTo(String)}.
     * Once a listener stops listening to a thing, it will call {@link #stoppedListening(String)}.
